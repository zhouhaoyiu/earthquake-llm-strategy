...
- Metrics: `work/ground_motion_residuals_10s/ground_motion_residual_metrics.csv`
- Per-record predictions: `work/ground_motion_residuals_10s/ground_motion_residual_predictions.csv`
- Metric deltas: `work/ground_motion_residuals_10s/ground_motion_residual_metric_deltas.csv`
- Binned residuals: `work/ground_motion_residuals_10s/ground_motion_residual_bins.csv`
- Correlations: `work/ground_motion_residuals_10s/ground_motion_residual_correlations.csv`
- Worst cases: `work/ground_motion_residuals_10s/ground_motion_residual_worst_cases.csv`
- Plots: `work/ground_motion_residuals_10s/plots`
- Figure-ready audit panels: `outputs/figures/ground_motion_audit`
