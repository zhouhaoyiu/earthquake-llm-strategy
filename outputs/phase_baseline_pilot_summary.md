...
- Runner: `work/scripts/run_phase_baseline_pilot.py`
- Python: `/Users/yojironoda/miniforge3/envs/zhy/bin/python`

## Outputs

- Two-model pilot:
  - `work/baseline_pilot/phase_baseline_pilot_predictions.csv`
  - `work/baseline_pilot/phase_baseline_pilot_summary.json`
- Four-model comparison:
  - `work/baseline_pilot_four_models/phase_baseline_pilot_predictions.csv`
  - `work/baseline_pilot_four_models/phase_baseline_pilot_summary.json`
- Worst-case waveform plots:
  - `outputs/baseline_worst_plots`
  - Plot script: `work/scripts/plot_phase_audit_examples.py`
...
- `outputs/baseline_worst_plots/instancegm_bucket491_546_3_12000.png`
- `outputs/baseline_worst_plots/iquique_bucket2_490_3_15441.png`
- `outputs/baseline_worst_plots/stead_bucket279_794_3_6000.png`
- `outputs/baseline_worst_plots/knet_KYT0070602181621.png`
- `outputs/baseline_worst_plots/iquique_bucket7_778_3_15961.png`
- `outputs/baseline_worst_plots/stead_bucket1117_320_3_6000.png`
