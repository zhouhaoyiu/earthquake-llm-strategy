...
- Script: `work/scripts/run_openquake_pga_reference.py`
- OpenQuake output: `work/ground_motion_balanced_station_10s/openquake_reference.csv`
- Comparison: `work/ground_motion_balanced_station_10s/openquake_comparison.csv`
- Figure: `outputs/figures/ground_motion_audit/openquake_reference_panel.png`
