...
| PGA | esm | source_only | raw_waveform | knet | 1.118 | -2.590 | 6.07 |
| PGA | esm | target_offset_calibrated | raw_waveform | instancegm | 0.461 | 0.171 | 2.53 |
...
| PGA | knet | source_only | raw_waveform | aq2009gm | 0.356 | -0.195 | 2.60 |
| PGA | knet | target_offset_calibrated | raw_waveform | esm | 0.290 | 0.303 | 2.12 |
...
| PGV | esm | source_only | raw_waveform | aq2009gm | 0.978 | -1.830 | 3.56 |
| PGV | esm | target_offset_calibrated | raw_waveform | instancegm | 0.433 | 0.276 | 1.58 |
| PGV | instancegm | source_only | log_waveform | aq2009gm | 0.315 | 0.549 | 1.32 |
| PGV | instancegm | target_offset_calibrated | raw_waveform | aq2009gm | 0.315 | 0.549 | 1.32 |

Boundary interpretation:
- Zero-shot transfer median MAE ratio vs target-domain training: 4.27.
- Target-train offset calibration median MAE ratio vs target-domain training: 2.46.
...
Files:
- `work/cross_region_waveform_transfer_esm_10s/cross_region_waveform_transfer_metrics.csv`
- `work/cross_region_waveform_transfer_esm_10s/cross_region_waveform_transfer_boundary.csv`
- `outputs/figures/ground_motion_audit/cross_region_waveform_transfer_esm_10s_boundary.png`
