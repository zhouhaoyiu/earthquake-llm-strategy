...
|---|---|---|---|---|---:|---:|---:|
| PGA | aq2009gm | source_only | log_waveform | instancegm | 0.273 | 0.636 | 1.52 |
| PGA | aq2009gm | target_offset_calibrated | raw_waveform | instancegm | 0.250 | 0.702 | 1.40 |
| PGA | esm | source_only | log_waveform | knet | 1.070 | -2.018 | 2.55 |
| PGA | esm | target_offset_calibrated | raw_waveform | instancegm | 0.540 | 0.005 | 1.26 |
| PGA | instancegm | source_only | log_waveform | aq2009gm | 0.649 | -0.420 | 1.41 |
| PGA | instancegm | target_offset_calibrated | raw_waveform | aq2009gm | 0.565 | -0.097 | 1.23 |
| PGA | knet | source_only | log_waveform | instancegm | 0.367 | -0.041 | 1.47 |
| PGA | knet | target_offset_calibrated | log_waveform | instancegm | 0.346 | -0.001 | 1.40 |
...
| PGV | esm | source_only | raw_waveform | aq2009gm | 0.885 | -1.396 | 1.92 |
| PGV | esm | target_offset_calibrated | log_waveform | instancegm | 0.551 | -0.094 | 1.18 |
| PGV | instancegm | source_only | log_waveform | aq2009gm | 0.429 | 0.322 | 1.26 |
| PGV | instancegm | target_offset_calibrated | log_waveform | aq2009gm | 0.418 | 0.371 | 1.24 |

Boundary interpretation:
- Zero-shot transfer median MAE ratio vs target-domain training: 2.25.
...
Files:
- `work/cross_region_waveform_transfer_esm_1s/cross_region_waveform_transfer_metrics.csv`
- `work/cross_region_waveform_transfer_esm_1s/cross_region_waveform_transfer_boundary.csv`
- `outputs/figures/ground_motion_audit/cross_region_waveform_transfer_esm_1s_boundary.png`
