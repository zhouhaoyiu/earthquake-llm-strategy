...
| Fig5_Residuals | Figure 5 | `outputs/figure5_residual_diagnostic_source_data.csv` | included | Residual diagnostic panel source data for error reductions and binned residual curves. |
