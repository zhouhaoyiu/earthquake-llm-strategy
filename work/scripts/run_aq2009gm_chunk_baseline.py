        ...
        with h5py.File(cache_dir / f"waveforms{chunk}.hdf5", "r") as h5:
            ...
            for _, row in chunk_metadata.iterrows():
                ...
                base = {
                    ...
                    "source_latitude_deg": to_float(row.get("source_latitude_deg")),
                    "source_longitude_deg": to_float(row.get("source_longitude_deg")),
                    "station_group": row.get("station_group", ""),
                    "station_network_code": row.get("station_network_code", ""),
                    "station_code": row.get("station_code", ""),
                    "station_latitude_deg": to_float(row.get("station_latitude_deg")),
                    "station_longitude_deg": to_float(row.get("station_longitude_deg")),
                    ...
                    "path_azimuth_deg": to_float(row.get("path_azimuth_deg")),
                    "path_back_azimuth_deg": to_float(row.get("path_back_azimuth_deg")),
