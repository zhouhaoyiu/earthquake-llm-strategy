...
const sources = [
  ...
  },
  {
    sheet: "Fig5_Status",
    figure: "Figure 5",
    source: "outputs/figure5_residual_waveform_audit_summary.md",
    notes: "Residual waveform diagnostics currently have figure and narrative artifacts; a consolidated numeric source table remains pending.",
    status: "pending numeric source table",
  },
  {
